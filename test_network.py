...
def load_model(model_dir):
    # config是config_ver1.py裡的config                             1024/2
...
if __name__ == "__main__":
    ...
    with open('assets/hresMapping.pkl', 'rb') as f:
        _, faces = pkl.load(f) #faces = <class 'numpy.ndarray'> (55104, 3)

    TEMPLATE = pkl.load(open('assets/allTemplate_withBoundaries_symm.pkl', 'rb'))
    pca_verts = {} # 讀取5種衣服的pkl
    ...
    ## Load model
    m = load_model(model_dir) # load model parameters and structure
